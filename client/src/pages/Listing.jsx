    ...
    <main>
      ...
      {listing && !loading && !error && (
        <>
          ...
          <div className="fixed top-[13%] right-[3%] z-10 border rounded-full w-12 h-12 flex justify-center items-center bg-green-100 cursor-pointer">
            <FaShare
          ...
          {copied && (
            <p className="fixed rop-[23%] right-[5%] z-10 rounded-md bg-green-100 p-2">
              Link copied!
            </p>
          )}
            ...
            <div className="flex gap-4">
              ...
              {listing.offer && (
                <p className="bg-slate-900 w-full max-w-[200px] text-white text-center p-1 rounded-md">
                  ${+listing.regularPrice - +listing.dissacountPrice} OFF
                </p>
              )}
            </div>
